...
import AnanyaImg from './img/WhatsApp Image 2025-06-29 at 2.47.17 PM (1).jpeg';
import AvadhootImg from './img/ChatGPT Image Jun 29, 2025, 06_16_45 PM.png';
...
const About: React.FC = () => {
  ...
  const team = [
    ...
    },
    {
      ...
      role: 'Backend + API Integration',
      image: AyushmanImg,
      description: 'IIT Kharagpur undergrad passionate about ML, GenAI, and impactful tech.'
    }
  ];
    ...
    <div className="bg-professional" style={{ paddingTop: '100px' }}>
      ...
      >
        <Card className="border-0 shadow-sm h-100">
          ...
          <Card.Body className="p-4 text-center">
            <h5 className="fw-bold text-secondary-custom mb-1">{lead.name}</h5>
            <p className="text-primary-custom fw-medium mb-3">{lead.role}</p>
            <p className="text-muted small mb-0">{lead.description}</p>
          </Card.Body>
        </Card>
      </motion.div>
    </Col>
